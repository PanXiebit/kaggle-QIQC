...
def compute_f1_precision_recall(out, labels):
...
def main(debug=False):
    ...
    # Prepare model
    # model = BertForSequenceClassification.from_pretrained("./pre_trained_models/bert-base-uncased.tar.gz",
    ...
    def train(global_step, epoch):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
            ...
            logits = model(input_ids, segment_ids, input_mask)          # [batch, 2]  without softmax
    ...
    def eval():
        eval_examples = processor.get_dev_examples(args.data_dir, debug=debug, debug_length=100)
    ...
    if args.do_train and args.do_eval:
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
                eval_loss, eval_acc, eval_f1, eval_precision, eval_recall = eval()
                if eval_f1 > best_f1:
                    best_f1 = eval_f1
                ...
                logger.info('epcoh {:d}, precision {:.4f}, recall {:.4f}, f1 {:.4f}, best_f1 {:.4f}'
                    .format(epoch, eval_precision, eval_recall, eval_f1, best_f1))
